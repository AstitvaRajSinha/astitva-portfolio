      ...
      <div className="text-center py-8 bg-zinc-950">
        <div className="text-center py-4">
          ...
          <p className="px-2 text-sm md:text-base">
            Stuff I Built (And Didn’t Break... Much)
          </p>
        </div>
...
const items = [
  {
    title: "Devlance",
    description: "A freelance website for Developers",
    header: <Skeleton src="/devlance.jpg" alt="Innovation" />,
  ...
  },
  {
    ...
    header: <Skeleton src="/connectify.jpg" alt="Digital Revolution" />,
  ...
  },
  {
    ...
    header: <Skeleton src="/ycdirectory.png" alt="Art of Design" />,
    className: "md:col-span-1",
  ...
  },
  {
    ...
    header: <Skeleton src="/bookify.jpg" alt="Communication" />,
    className: "md:col-span-2",
